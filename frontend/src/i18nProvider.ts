...
const frResources = { resources: {"Users":{"name":"Utilisateurs","fields":{"userId":"ID d'utilisateur","email":"Courriel","name":"Nom","id":"id"}},"Cards":{"name":"Cartes","fields":{"cardId":"ID de carte","setid":"ID de set","cardName":"Nom de la carte","serial":"Série","type":"Type","rarity":"Rareté","condition":"État","imageurl":"URL de l'image","id":"id"}},"Sets":{"name":"Séries","fields":{"setId":"ID de série","setname":"Nom de la série","releasedate":"Date de sortie","totalcards":"Total des cartes","id":"id"}},"Inventory":{"name":"Inventaire","fields":{"userId":"ID d'utilisateur","cardId":"ID de carte","recordedDate":"Date d'enregistrement","id":"id"}},"Wishlist":{"name":"Liste de souhaits","fields":{"userId":"ID d'utilisateur","cardId":"ID de carte","insertedDate":"Date d'insertion","id":"id"}}}};
