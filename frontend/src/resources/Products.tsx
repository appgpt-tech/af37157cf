                    ...
                    <Edit title={<ProductsTitle />}>
                      <SimpleForm>
                        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
                          <Grid item xs={4}>
<TextInput source="productName"   /></Grid>
<Grid item xs={4}>
<ReferenceInput source="vendor"  reference="Vendors"   /></Grid>
<Grid item xs={4}>
...
<Grid item xs={4}>
<ImageInput source="thumbnail"   /></Grid>
<Grid item xs={4}>
<ImageInput source="image"   /></Grid>
<Grid item xs={4}>
<ReferenceInput source="category"  reference="ProductCategories"   /></Grid>
<Grid item xs={4}>
<DateInput source="creationDate"   /></Grid>
<Grid item xs={4}>
<NumberInput source="stock"   /></Grid>
                        </Grid>
                      </SimpleForm>
                    </Edit>
                  );
