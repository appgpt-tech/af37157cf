                    ...
                    <Edit title={<PaymentsTitle />}>
                      <SimpleForm>
                        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
                          <Grid item xs={4}>
<ReferenceInput source="orderNumber"  reference="Orders"   /></Grid>
<Grid item xs={4}>
<NumberInput source="amount"   /></Grid>
<Grid item xs={4}>
<TextInput source="paymentMethod"   /></Grid>
<Grid item xs={4}>
<DateInput source="paymentDate"   /></Grid>
<Grid item xs={4}>
<TextInput source="paymentStatus"   /></Grid>
                        </Grid>
                      </SimpleForm>
                    </Edit>
                  );
